<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">เพิ่มห้องประชุม</h2>
    </x-slot>

    <div class="py-6 max-w-xl mx-auto sm:px-6 lg:px-8">
        <form action="{{ route('rooms.store') }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="capacity" value="{{ old('capacity', 0) }}" class="w-full border rounded p-2">
